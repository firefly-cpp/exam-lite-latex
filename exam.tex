...
\qncounter{3}
\longquestion{Naštejte vsaj 5 tehnik priprave podatkov in zapišite njihove značilnosti in za kakšen namen se določena tehnika uporablja?}{6}{s}{0}

\begin{enumerate}[i]
    \alinea{Zakaj je pomembno izvesti pripravo podatkov preden začnemo učiti klasifikator?}{4}{s}{2}
    \alinea{Kaj pomeni termin \textbf{podatkovna množica} in kako je sestavljena?}{1}{}{2}
\end{enumerate}
