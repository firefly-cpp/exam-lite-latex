...
\begin{enumerate}[i]
    ...
    \alinea{Ali je vedno potrebno izvesti postopek priprave podatkov?}{2}{i}{1}
    \alinea{Kaj pomeni termin \textbf{podatkovna množica} in kako je sestavljena?}{2}{i} {1}
    \alinea{Ali je vedno potrebno izvesti postopek priprave podatkov?Ali je vedno potrebno izvesti postopek priprave podatkov?Ali je vedno potrebno izvesti postopek priprave podatkov?Ali je vedno potrebno izvesti postopek priprave podatkov?Ali je vedno potrebno izvesti postopek priprave podatkov? }{2}{i} {1}
\end{enumerate}
